...
********************************************************************************
*
* FILE: 1-logit-demand.do
*
* BY: Dmitry Sedov 
*
* CREATED: Thu Mar 19 2020
*
* DESC: Logit demand estimation using section and panel data.
*
********************************************************************************
********************************************************************************
...
log using "/home/quser/project_dir/urban/docs/logit-demand-panel", text replace
...
reghdfe lsj_ls0 total_est, absorb(home_cbg_id rest_id home_cbg_id#rest_id year#month) vce(cluster home_cbg_id rest_id)

reghdfe lsj_ls0 naics*, absorb(home_cbg_id rest_id home_cbg_id#rest_id year#month) vce(cluster home_cbg_id rest_id)
