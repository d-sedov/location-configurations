...
eststo: reghdfe lsj_ls0 distance_closest_point_km distance_closest_point_km_2 i.price rating rating_2 area_m2 i.naics_code cbg_est_number, absorb(brands category1) vce(cluster home_cbg rest_id) noconstant
eststo: reghdfe lsj distance_closest_point_km distance_closest_point_km_2, absorb(home_cbg rest_id) vce(cluster home_cbg rest_id) noconstant

* IV logit specification
eststo: ivreghdfe lsj distance_closest_point_km distance_closest_point_km_2 (i.price = i.category1_equal neighbor_price) rating rating_2 area_m2 i.naics_code cbg_est_number, absorb(home_cbg brands category1) cluster(home_cbg rest_id) first noconstant

* Nested logit specifications
eststo: reghdfe lsj distance_closest_point_km distance_closest_point_km_2 i.price rating rating_2 within_group area_m2 i.naics_code cbg_est_number, absorb(home_cbg brands) vce(cluster home_cbg rest_id)
eststo: reghdfe lsj_ls0 distance_closest_point_km distance_closest_point_km_2 i.price rating rating_2 within_group area_m2 i.naics_code cbg_est_number, absorb(brands) vce(cluster home_cbg rest_id)
eststo: ivreghdfe lsj distance_closest_point_km distance_closest_point_km_2 rating rating_2 (i.price within_group = i.category1_equal neighbor_price group_distance) area_m2 i.naics_code cbg_est_number, absorb(home_cbg brands) cluster(home_cbg rest_id) first noconstant
