...
set linesize 200
log using "/home/quser/project_dir/urban/docs/logit-demand-cross-section", text replace
* Import data
...
ivreghdfe lsj_ls0 distance_closest_point_km distance_closest_point_km_2 i.price rating (within_group = group_distance) area_m2 i.naics_code, absorb(home_cbg brands) cluster(home_cbg rest_id)
