...
############################# PARAMETERS #######################################
api_key=***REMOVED***
input_folder_path=/home/user/projects/urban/data/processed/intermediate_use/yelp_request_locations/do_part/to_do/
output_folder_path=/home/user/projects/urban/data/input/Yelp/from_api/do_part/
log_file_path=/home/user/projects/urban/code/yelp-api-download/logs/yelp_api_do.log
done_folder_path=/home/user/projects/urban/data/processed/intermediate_use/yelp_request_locations/do_part/done/
################################################################################
